<h2><a href="https://leetcode.com/problems/minimum-rectangles-to-cover-points">3390. Minimum Rectangles to Cover Points</a></h2><h3>Medium</h3><hr><p>You are given a 2D integer array <code>points</code>, where <code>points[i] = [x<sub>i</sub>, y<sub>i</sub>]</code>. You are also given an integer <code>w</code>. Your task is to <strong>cover</strong> <strong>all</strong> the given points with rectangles.</p>
